...
module.exports = {
    ...
    execute(message, args){
        ...
        */
        ...
        if(args[1].split('/')[1].length == 5){
            ...
            if(date == 0){
                if(statusMinute == 'sub' && statusHour == 'sub'){
                    return message.reply('Going back in time is a feature that you need to pay')
        ...
        console.log(judges) 
        return message.reply("[Dev] In " +tte / 60000 +" minutes,("+ tte +" ms) I am judging those judges: " + judges)
    }
}